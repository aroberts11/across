...
install_bbr() {
    ...
    if [[ "${release}" == "centos" ]]; then
        ...
        rpm --import https://www.elrepo.org/RPM-GPG-KEY-elrepo.org
        yum install -y http://elrepo.org/linux/kernel/el6/x86_64/RPMS/kernel-ml-4.12.10-1.el6.elrepo.x86_64.rpm
        yum remove -y kernel-headers
        yum install -y http://elrepo.org/linux/kernel/el6/x86_64/RPMS/kernel-ml-headers-4.12.10-1.el6.elrepo.x86_64.rpm
        yum install -y http://elrepo.org/linux/kernel/el6/x86_64/RPMS/kernel-ml-devel-4.12.10-1.el6.elrepo.x86_64.rpm
        if [ $? -ne 0 ]; then
